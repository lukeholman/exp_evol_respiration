...
ggsave("figures/metabolite_plot.pdf", p1, height=4, width=6)
p1
```
...
treat_diff_standard_dryweight %>%
  ...
  coord_cartesian(ylim = ylims) + 
  ylab("Difference in means between\nselection treatments (P - M)") + xlab("Sex") + 
  #ggsave('figures/metabolite_plotCONTROLLED.pdf', height=4, width=6) +
  NULL
```
...
ggsave("figures/metabolite_interaction_plot.pdf", p2, height=4, width=6)
p2
```
