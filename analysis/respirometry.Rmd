...
if(!file.exists("output/brms_SEM_respiration.rds")){
  ...
  #saveRDS(brms_SEM_respiration, "output/brms_SEM_respiration_noslope.rds") # save with no random slope term
...
#                           ggplotGrob(pz)),
#              layout_matrix = lay) %>%
#   ggsave("figures/respiration_figure_cycleI.pdf", plot = ., height = 2.5, width = 5.5)
