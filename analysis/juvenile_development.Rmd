...
Here are some useful links for understanding [survival analyis](). For instance, [this link](http://www.sthda.com/english/wiki/cox-proportional-hazards-model) provides an explanation of how to interpret hazard ratios. 
...
I found [this link](https://bookdown.org/content/4857/god-spiked-the-integers.html) useful for fitting survival models in `brms`. 
